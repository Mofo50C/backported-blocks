...
public class BlockNetherBricks extends BlockModGeneric {

    public static final PropertyEnum<EnumType> VARIANT = PropertyEnum.create("variant", EnumType.class);

    public BlockNetherBricks(IForgeRegistry<Block> registry) {
        super(registry, "nether_bricks", 2f, 6f);
    }
